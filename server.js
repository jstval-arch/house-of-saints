...
// ========================================
// 4. AUDIO PROXY (CRASH-PROOF)
// ========================================
app.get('/api/proxy-audio', async (req, res) => {
  const audioUrl = req.query.url;

  // SAFETY CHECK: Stop crashes if URL is missing or bad
  if (!audioUrl || audioUrl === 'undefined' || !audioUrl.startsWith('http')) {
    // console.log("⚠️ Blocked invalid proxy request"); // Optional log
  ...
  try {
    ...
    // Safety check for the fetch itself
